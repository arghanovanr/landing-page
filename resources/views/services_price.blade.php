...
<div class="row row-cols-1 row-cols-md-3 mb-3 m-5">
    <div class="col-lg-4 d-flex align-items-stretch">
      <div class="card mb-4 rounded-3 shadow-sm border border-danger ">
        <div class="card-header py-3 text-white bg-warning text-center">
        ...
        <div class="card-body text-left h-25px" >
           <p>Jadikan website Anda lebih terpercaya dan disukai oleh search engine dengan menggunakan SSL Certificate.</p>
            ...
            <div class="mx-3 mb-3">
                <p>Mulai dari</P>
                <h1 class="card-title pricing-card-title">Rp 112.000<small class="text-muted fw-light">/thn</small></h1>
                <button type="button" class="w-100 btn btn-lg text-white btn-warning">Order Sekarang</button>
            </div>
        </div>
    </div>
    <div class="col-lg-4 d-flex align-items-stretch">
        <div class="card mb-4 rounded-3 shadow-sm border border-danger ">
          ...
          <div class="mx-3 mb-3">
            <p>Mulai dari</P>
            <h1 class="card-title pricing-card-title">Rp 499.000<small class="text-muted fw-light">/thn</small></h1>
            <button type="button" class="w-100 btn btn-lg text-white btn-warning">Order Sekarang</button>
          </div> 
        </div>
      </div>
      <div class="col-lg-4 d-flex align-items-stretch">
        <div class="card mb-4 rounded-3 shadow-sm border border-danger ">
          ...
          <div class="mx-3 mb-3">
            <p>Mulai dari</P>
            <h1 class="card-title pricing-card-title">Rp 500.000<small class="text-muted fw-light">/thn</small></h1>
            <button type="button" class="w-100 btn btn-lg text-white btn-warning">Order Sekarang</button>
          </div> 
        </div>
      </div>
